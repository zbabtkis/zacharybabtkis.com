...
export default function WebRequestAlternativePage() {
  return (
    <ArticleLayout
      ...
      ctaBody="I did this migration for an ad blocker with two million users. The port assessment maps every one of your webRequest usages to its Safari answer — kept, redesigned, or cut — with a fixed quote for the work."
    ...
    >
      <p>
        ...
        just never fire with the power you expected. This is not a bug in
        your port — it&rsquo;s Safari&rsquo;s design, and pretending
      ...
      <p>
        ...
        of time — match patterns, resource types, actions like block,
        redirect, or header modification — and the browser applies them
        itself. Chrome pushed the same direction with Manifest V3, so if
        you already built DNR rules for Chrome, a meaningful part of your
        Safari migration is done. The differences that remain are in rule
        limits, supported action types, and versioned behavior — which you
        verify against the Safari versions you support, not against a blog
        post.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          it&rsquo;s a design task, not a port.
        </li>
        <li>
      ...
      <ol>
        <li>
          ...
          what each one actually accomplishes for the user — not how it
          does it.
        </li>
        <li>
        ...
        <li>Test per Safari version — behavior genuinely varies.</li>
      </ol>
      <p>
        The honest summary: DNR is less powerful and more predictable. For
