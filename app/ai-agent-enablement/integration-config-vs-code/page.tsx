...
export const metadata: Metadata = {
  ...
  description:
    'Hardcode each integration, let a model generate it at runtime, build a step DSL, or run sandboxed code behind a fixed contract? Two of those were tried and abandoned on a real agent-provisioning system. What worked, and why.',
};
...
export default function IntegrationConfigVsCodePage() {
  return (
    <ArticleLayout
      title="Config, DSL, or code: structuring dozens of third-party integrations"
      description="Four ways to represent third-party integrations an agent executes — two of which failed on a real system — and the split that held up."
    ...
    >
      ...
      <p>
        ...
        execute — provisioning real accounts and credentials on real
        providers. We demoed it to partners and advertisers, and it shaped
      ...
      <p>
        ...
        engineers, a solutions team, an operator — and a hardcoded model
      ...
      <p>
        We tried this — a retrieval pipeline over provider documentation,
        with the model generating the integration on the fly — and killed
        ...
        Nothing to review, nothing to diff, nothing to point to when a
      ...
      <p>
        ...
        production. The model accelerates the writing; it stays out of the
        running.
      </p>
      ...
      <p>
        Then a real provider arrives. One of our integrations — Supabase
        is the illustrative case — ran a couple hundred lines: poll the
        ...
        programming language — one with no debugger, no ecosystem, and
        tooling only your team maintains. We killed the DSL for exactly
        this: real provisioning needs loops, conditionals, and polling that
        a step format can&rsquo;t express.
      </p>

      <h2>Option 4: split by what is actually standardized</h2>
      <p>
        The design that held up starts from an observation about the
        problem rather than a preference about representation.
        Authentication is standardized across providers. OAuth flows, API
        keys, token endpoints — the variation fits a schema. The setup
      ...
      <ul>
        ...
        <li>
          ...
          quietly collapses back into option 1.
        </li>
        <li>
          ...
          failed, required fields incomplete — and every one of them
        ...
        <li>
          ...
          distinct threat model, and the sandbox boundary — what the
          injected request function may reach, what the code may log, what
          credentials it may see — demands its own controls. That is a
      ...
      <p>
        ...
        formats for the parts of the problem that are genuinely uniform,
