...
export const metadata: Metadata = {
  ...
  description:
    'You vibe-coded a prototype that works in a demo. I turn AI-built POCs into products that survive real users: tests, auth, data, deployment. Every engagement is fixed-price.',
};
    ...
    <>
        ...
        <div className="wrap">
          <div className="hero-copy">
            ...
            <p className="lede">
              ...
              agents myself and shipped a product where they wrote the
          ...
          <div className="hero-art">
            <TerminalCard
              lines={[
                ...
                <>
                  <span className="ok">✓ launched · real users</span>
                </>,
              ]}
            />
          </div>
      ...
      <StatBand
        stats={[
          {
            value: '100%',
            label: 'of pie.yt written by AI agents, shipped to production by me',
            href: RECEIPTS.pieYt,
          },
          {
            value: '10 wks',
      ...
      <Chapter label="Why me" title="I build with agents, and I know where they cut corners." id="proof">
        <div className="prose">
          <p>
            ...
            reasons. First, I build with AI agents every day. At ZeroClick
            I shipped <a href={RECEIPTS.pieYt}>pie.yt</a>, a production
            product whose entire codebase was agent-written, so I know
            what AI-built code gets right, where it cuts corners,
      ...
      <OfferBand
        ...
        deliverables={[
          ...
          'Test and deployment plan sized to your product',
        ...
        <RatesTable
          ...
          rates={[
            ...
            },
            {
              ...
              scope:
                'Only the parts that block launch: usually auth, data integrity, and deployment. The rest waits until you have budget.',
              duration: '2–4 weeks',
              price: '$10k–$20k',
            },
            {
          ...
          steps={[
            {
              name: 'Audit',
              description:
                'Fixed price, one week. You learn what you have, what it needs, and what the finish line costs. The audit is useful even if someone else does the work.',
            },
            {
              name: 'The finish line',
              description:
                'Fixed bid. I do the production work, with agents where they’re strong and by hand where it counts. You can watch every PR land.',
            },
            {
              name: 'Launch & handoff',
              description:
        ...
        items={[
          {
            ...
            answer:
              'Almost never wholesale. AI-built code is usually a mix: solid CRUD and UI, shaky auth, data, and edge cases. The audit maps which is which, and the plan keeps everything that’s sound. A full rewrite recommendation happens only when it’s cheaper, and the audit shows the math.',
          },
          {
            question: 'My POC is in a stack you might not know.',
            answer:
              'If it came out of Claude, Cursor, Lovable, Replit, or Bolt, it’s almost certainly TypeScript/React/Node or Python, my stack. If it’s something else, I’ll say so on the intro call rather than learn on your invoice.',
          },
          {
          ...
          },
          {
            ...
            answer:
              'You own everything: work-for-hire, in your repos from day one. NDAs are fine. Your idea is yours. I build products for clients and don’t compete with them.',
          },
          {
