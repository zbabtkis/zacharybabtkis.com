...
export const metadata: Metadata = {
  ...
  description:
    'How to pause an MCP tool call mid-execution to collect input from a human: the elicitation request shape, the suspend-and-resume mechanics, the timeout design, and the read-your-writes race that bites everyone — from an engineer who shipped it in production.',
};
  ...
  return (
    ...
    >
      <p>
        ...
        forces the question — an interactive step in the middle of an
      ...
      <p>
        ...
        payload drove two completely different renderers: an HTML form in
        a web view and a native form drawn by the MCP client itself. No
      ...
      <ol>
        ...
        <li>
          ...
          every second, with a bounded deadline.
        </li>
        <li>
      ...
      <p>
        ...
        back. All the machinery — the store, the status transition, the
        polling — lives underneath that one awaited call. That is the
      ...
      <p>
        ...
        system I built gave each execution a five-minute budget — plenty
        for API calls and polling loops, and a hard stop for runaway
        code. A user who takes six minutes to decide on a project name
        would blow that budget while the code did nothing at all.
      </p>
      <p>
        The fix: re-arm the execution timeout every time an elicitation
        ...
        after which an abandoned job gets cleaned up — that one is a
        product decision, not an execution budget.
      </p>
      ...
      <p>
        ...
        question, re-rendered the form, and asked the user again — a
      ...
      <p>
        ...
        is answered; any without is genuinely open. If you find yourself
      ...
      <p>
        ...
        The system I built evolved exactly this way — the first version
      ...
      <p>
        ...
        known-unknown wearing a disguise — move it up front.
      </p>
      ...
      <p>
        ...
        someone else&rsquo;s flow — and elicitation answers frequently
      ...
      <p>
        ...
        region choice determines which plans exist; the account chosen
        determines which projects can be named. Process elicitations
      ...
      <p>
        ...
        the missing pieces exactly when they matter, and nothing already
